...
import { useCard } from "../../common/contexts/card-context";
import CommonItems from "../layouts/menu/CommonItems"
import Item from "../layouts/menu/Item";
import ItemNews from "../layouts/menu/ItemNews";
import Taskbar from "../layouts/menu/Taskbar";

const Menu = () => {
  // TODO: Fix when call API.
